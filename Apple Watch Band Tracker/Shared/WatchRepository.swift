...
class WatchRepository {
    ...
    private let sampleWatches = [
        ...
        Watch(series: 0, material: .gold, finish: .yellowGoldEdition, size: 42),
        Watch(series: 0, material: .gold, finish: .roseGoldEdition, size: 38),
        Watch(series: 2, material: .ceramic, finish: .whiteCeramic, size: 42),
        Watch(series: 3, material: .ceramic, finish: .grayCeramic, size: 42),
        Watch(series: 4, material: .stainlessSteel, finish: .gold, size: 40),
        Watch(series: 5, material: .titanium, finish: .silver, size: 40),
        Watch(series: 5, material: .titanium, finish: .spaceBlack, size: 44),
