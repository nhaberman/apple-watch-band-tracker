...
class WatchRepository {
    ...
    private let sampleWatches = [
        ...
        Watch(series: 0, material: .stainlessSteel, finish: .spaceBlack, size: 38),
        ...
        Watch(series: 0, material: .stainlessSteel, finish: .silver, size: 42, edition: "Hermes"),
        ...
        Watch(series: 5, material: .ceramic, finish: .whiteCeramic, size: 44, edition: "Edition"),
        //Watch(series: "SE", material: .aluminum, finish: .silver, size: 40),
        //Watch(series: "SE", material: .aluminum, finish: .spaceGray, size: 44),
        //Watch(series: "SE", material: .aluminum, finish: .gold, size: 44),
        ...
        Watch(series: 6, material: .stainlessSteel, finish: .spaceBlack, size: 44, edition: "Hermes"),
        Watch(series: 7, material: .aluminum, finish: .green, size: 41),
        Watch(series: 7, material: .aluminum, finish: .starlight, size: 41),
        ...
        Watch(series: 7, material: .aluminum, finish: .midnight, size: 45, edition: "Nike"),
        Watch(series: 7, material: .titanium, finish: .silver, size: 45, edition: "Edition"),
        //Watch(series: "SE2", material: .aluminum, finish: .silver, size: 44),
        //Watch(series: "SE2", material: .aluminum, finish: .starlight, size: 44),
        //Watch(series: "SE2", material: .aluminum, finish: .midnight, size: 40),
        Watch(series: 8, material: .aluminum, finish: .silver, size: 41),
        Watch(series: 8, material: .stainlessSteel, finish: .gold, size: 45),
        //Watch(series: "Ultra", material: .titanium, finish: .natural, size: 49),
        Watch(series: 9, material: .aluminum, finish: .pink, size: 41),
        Watch(series: 9, material: .aluminum, finish: .midnight, size: 45),
        Watch(series: 9, material: .stainlessSteel, finish: .silver, size: 45),
        //Watch(series: "Ultra2", material: .titanium, finish: .natural, size: 49),
        Watch(series: 10, material: .aluminum, finish: .silver, size: 42),
        Watch(series: 10, material: .aluminum, finish: .roseGold, size: 42),
        Watch(series: 10, material: .aluminum, finish: .jetBlack, size: 46),
        Watch(series: 10, material: .titanium, finish: .natural, size: 46),
        Watch(series: 10, material: .titanium, finish: .gold, size: 42),
        Watch(series: 10, material: .titanium, finish: .slate, size: 46),
        Watch(series: 10, material: .titanium, finish: .silver, size: 46, edition: "Hermes"),
        //Watch(series: "Ultra2", material: .titanium, finish: .black, size: 49),
        //Watch(series: "Ultra2", material: .titanium, finish: .natural, size: 49, edition: "Hermes"),)
    ]
}
